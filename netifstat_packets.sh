...
arrayName=($(netstat -i | awk '{if(NR<='$NINTERFACES+2' && NR>=3) print $1}')) #  echo ${arrayName[*]}
...
if [[ $# -eq 1 ]]; then
	echo -e "NETIF \tTX \tRX \tTRATE \tRRATE"
    ...
    case "${o}" in
		...
		k)
			arrayName=($(netstat -i | awk '{if(NR<='$NINTERFACES+2' && NR>=3) print $1}')) #  echo ${arrayName[*]}
 			...
 			arrayTX=($(netstat -i | awk '{if(NR<='$NINTERFACES+2' && NR>=3) print $7*'$kb'}'))
 
 			arrayRX=($(netstat -i | awk '{if(NR<='$NINTERFACES+2' && NR>=3) print $3*'$kb'}'))
 
 			arrayTRATE=($(netstat -i | awk '{if(NR<='$NINTERFACES+2' && NR>=3) print ($7*'$kb')/'$time'}'))
 
 			arrayRRATE=($(netstat -i | awk '{if(NR<='$NINTERFACES+2' && NR>=3) print ($3*'$kb')/'$time'}'))
		...
		m)	
			arrayName=($(netstat -i | awk '{if(NR<='$NINTERFACES+2' && NR>=3) print $1}')) #  echo ${arrayName[*]}
 			...
 			arrayTX=($(netstat -i | awk '{if(NR<='$NINTERFACES+2' && NR>=3) print $7*'$mb'}'))
 
 			arrayRX=($(netstat -i | awk '{if(NR<='$NINTERFACES+2' && NR>=3) print $3*'$mb'}'))
 
 			arrayTRATE=($(netstat -i | awk '{if(NR<='$NINTERFACES+2' && NR>=3) print ($7*'$mb')/'$time'}'))
 
 			arrayRRATE=($(netstat -i | awk '{if(NR<='$NINTERFACES+2' && NR>=3) print ($3*'$mb')/'$time'}'))	
